...
extern "C" {
#endif
OMX_HANDLETYPE Exynos_OSAL_ImgConv_Create(OMX_U32 nWidth, OMX_U32 nHeight);
void Exynos_OSAL_ImgConv_Terminate(OMX_HANDLETYPE hImgConv);
OMX_ERRORTYPE Exynos_OSAL_ImgConv_Run(OMX_HANDLETYPE hImgConv, OMX_COMPONENTTYPE *pOMXComponent, OMX_PTR pBuffer);
#ifdef __cplusplus
}
#endif
